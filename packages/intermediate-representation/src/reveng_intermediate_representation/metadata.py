"""Typed, immutable metadata with deterministic ordering.
...
__all__ = ["MetadataKey", "MetadataValue", "MetadataBag"]

# Metadata keys are plain strings; values are canonicalizable scalars.
MetadataKey = str
