"""Desktop-sdk tests: DesktopClient/DesktopManager get_reasoning."""
...
def test_client_get_reasoning() -> None:
    ...
    reasoning = client.get_reasoning(submission.job_id)
    assert isinstance(reasoning.inferences, list)


def test_manager_get_reasoning(tmp_path: Path) -> None:
    ...
    reasoning = manager.get_reasoning(submission.job_id)
    assert isinstance(reasoning.inferences, list)
